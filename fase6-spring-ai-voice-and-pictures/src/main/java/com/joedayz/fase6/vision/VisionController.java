...
@Tag(name = "Vision", description = "Análisis de imágenes con GPT-4 Vision vía Spring AI")
public class VisionController {
    ...
    @Operation(summary = "Describir / analizar imagen",
               description = "Sube una imagen y haz una pregunta sobre ella. GPT-4 Vision la analizará y responderá.")
