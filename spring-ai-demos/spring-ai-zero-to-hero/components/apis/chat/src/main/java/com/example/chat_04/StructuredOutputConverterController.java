    ...
    return chatClient
        ...
        .user(
            u ->
                u.text(
                        """
                Provide a list of the top 5 plays written by {author}.
                If no plays are found, return an empty list.
        ...
        .user(
            u ->
                u.text(
                        """
                Provide a list of the top 5 plays written by {author}.
                If no plays are found, return an empty map.
                Provide only the list, no other commentary.
                """)
                    .param("author", topic))
        .call()
        ...
        .user(
            u ->
                u.text(
                        """
                Provide a list of the top 5 plays written by {author}.
                If no plays are found, return an empty array.
                Provide only the list, no other commentary.
                """)
                    .param("author", topic))
        .call()
