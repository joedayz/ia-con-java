...
public class DocumentController {
  ...
  public String bikeJsonToDocs() {
    ...
    return """
                ...
                The documents were split into %s chunks
                Embedding for example chunk computed has %s dimensions
                document id is %s
  ...
  public String paragraphs() {
    ...
    this.embeddingModel.embed(chunks.get(0));
    var pdfToDocsSummary =
        """
            Input pdf read from %s
            ...
            document id is %s
            document metadata is %s
            first chunk contents between the two dashed lines below
            ---
            %s
            ---
            """
