...
/**
 * Búsqueda semántica persistente con PgVector usando embeddings de OpenAI.
 *
...
public class SemanticSearchService {
    ...
    public int cargarDocumentosDemo() {
        ...
        documentos.add(new Document(
                "OpenAI ofrece modelos de chat y embeddings por API; requiere OPENAI_API_KEY y dimensiones de vector acordes al modelo de embedding.",
                Map.of("tema", "openai", "fuente", "teoria")));
        documentos.add(new Document(
