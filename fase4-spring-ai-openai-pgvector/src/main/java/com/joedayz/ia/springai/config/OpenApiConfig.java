...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Fase 4 - Spring AI + OpenAI + PgVector API")
                        .version("1.0.0")
                        .description("""
                                API REST para chatbot con RAG usando Spring AI, OpenAI y PgVector.
                                ...
                                **Características:**
                                ...
                                - 🤖 OpenAI para chat y embeddings (API key)
                                - 🐘 PostgreSQL + PgVector como vector store (HNSW index)
                                
                                **Proveedor:** OPENAI + PGVECTOR
