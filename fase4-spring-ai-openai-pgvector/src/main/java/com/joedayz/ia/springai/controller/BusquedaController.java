...
@Tag(name = "🔍 Búsqueda Semántica", description = "Búsqueda por similitud usando embeddings de OpenAI sobre PgVector")
public class BusquedaController {
    ...
    @Operation(
            ...
            description = "Verifica el estado del PgVectorStore y la disponibilidad del modelo de embeddings de OpenAI.",
            responses = {
    ...
    @Operation(
            ...
            description = "Busca los documentos más relevantes usando embeddings de OpenAI y similitud coseno en PgVector.",
            responses = {
