...
/**
 * Step 07: tools ({@link BookingTools}) + RAG manual + fecha actual en el system prompt.
 * Respuesta síncrona (sin streaming) para simplificar el tool calling, como en Quarkus step-07.
 */
@Service
