# Test script para Fase 4 - Spring AI + Ollama + PgVector (Windows PowerShell)
# Prerequisitos: Docker/Podman (PostgreSQL+pgvector), Ollama (llama3.2, mxbai-embed-large)

$BASE_URL = "http://localhost:8080"
$headers = @{ "Content-Type" = "application/json" }

Write-Host "============================================" -ForegroundColor Cyan
Write-Host "  Fase 4: Spring AI + Ollama + PgVector"     -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
