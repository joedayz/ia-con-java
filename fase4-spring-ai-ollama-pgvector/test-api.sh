#!/bin/bash
# Test script para Fase 4 - Spring AI + Ollama + PgVector
# Prerequisitos: Docker (PostgreSQL+pgvector), Ollama (llama3.2, mxbai-embed-large)

BASE_URL="http://localhost:8080"

echo "============================================"
echo "  Fase 4: Spring AI + Ollama + PgVector"
echo "============================================"
