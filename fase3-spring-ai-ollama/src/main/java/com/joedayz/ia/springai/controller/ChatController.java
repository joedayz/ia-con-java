...
/**
 * Controlador REST para el chatbot con memoria conversacional.
 */
@RestController
...
public class ChatController {
    ...
    @Operation(
            ...
            description = "Envía un mensaje usando un ID de sesión específico. Cada sesión mantiene su propio historial conversacional independiente.",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Respuesta exitosa del chatbot"),
