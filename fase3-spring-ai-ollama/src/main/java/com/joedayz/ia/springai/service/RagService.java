    ...
    public RagResponse answer(RagRequest request) {
        ...
        if (contextDocs.isEmpty()) {
            return new RagResponse(
                    question,
                    "No encontré contexto suficiente en el vector store. Primero indexa documentos con /api/buscar/demo, /api/buscar/pdf o /api/rag/docs/cargar.",
                    topK,
                    false,
                    List.of());
        }
