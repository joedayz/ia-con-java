...
/**
 * Endpoints RAG con Ollama: pipeline manual, advisor y asistente de documentación.
 */
@RestController
@RequestMapping("/api/rag")
@Tag(name = "🧠 RAG", description = "Retrieval Augmented Generation con Ollama")
public class RagController {
    ...
    @Operation(
            ...
            description = "Pipeline manual: búsqueda semántica, construcción del contexto y generación de respuesta con citas.",
            responses = {
    ...
    @Operation(
            ...
            description = "Usa el advisor de Spring AI para automatizar búsqueda, inyección de contexto y generación.",
            responses = {
    ...
    @Operation(
            summary = "Cargar archivos Markdown para el asistente",
            description = "Carga todos los archivos .md de un directorio, los divide por secciones y los indexa en el vector store.",
            responses = {
    ...
    @Operation(
            ...
            description = "Hace RAG sobre la documentación previamente cargada con /api/rag/docs/cargar.",
            responses = {
