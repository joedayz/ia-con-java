# =============================================
# test-api.ps1 — Fase 6: Spring AI Voice & Pictures (Ollama)
# =============================================
# Uso: .\test-api.ps1
...
Write-Host " Fase 6 — Spring AI Voice & Pictures (Ollama) " -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan
Write-Host ""
...
# ---- Imagen URL ----
Write-Host ">>> [3/5] Image generate-url: generando imagen con Ollama..." -ForegroundColor Yellow
