...
@Tag(name = "Image Generation", description = "Generación de imágenes local con Ollama + SVG")
public class ImageController {
    ...
    /**
     * Genera una imagen y devuelve una data URL (base64 PNG).
     */
    @Operation(summary = "Generar imagen (URL)",
               description = "Genera una imagen 1024x1024 usando Ollama y devuelve data URL con PNG en base64")
    ...
    @Operation(summary = "Generar imagen (PNG)",
               description = "Genera una imagen 1024x1024 usando Ollama (SVG) y la renderiza a PNG")
